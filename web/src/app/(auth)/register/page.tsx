    ...
    <main className="mx-auto flex min-h-dvh max-w-md flex-col justify-center px-6 py-10">
      ...
      <form action={registerAction} className="space-y-4">
        <div>
          ...
          <input type="text" id="display_name" name="display_name" required maxLength={30} placeholder="例:あかり" />
        </div>
        <div>
      ...
      <p className="mt-6 text-center text-sm" style={{ color: "var(--color-muted)" }}>
        アカウントをお持ちの方は{" "}
        <Link href="/login" className="font-bold" style={{ color: "var(--color-accent)" }}>
          ログイン
        </Link>
      </p>
    </main>
